...
class TestCalcularMedia:
    ...
    def test_media_notas_com_uma_invalida(self):
        """Testa cálculo de média ignorando uma nota inválida."""
        # ARRANGE
        notas = [4, 6, 8, 10, 15]  # 15 é inválida
    ...
    def test_media_todas_notas_invalidas(self):
        """Testa cálculo com todas as notas inválidas retorna 0."""
        # ARRANGE
        notas = [-1, 15, 20, "abc"]
